...
const SELECT = `id, data, socio_id, origem, destino, escalas, horas_pernas, horimetro_inicial, horimetro_final, horas,
...
type LinhaBruta = {
  id: string; data: string; socio_id: string | null; origem: string | null; destino: string | null; escalas: string[] | null; horas_pernas: (string | number)[] | null;
