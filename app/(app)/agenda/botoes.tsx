...
import { cancelarReserva, cederSemana, escolherSemana, removerBloqueio, type Resultado } from "./acoes";
...
export function BotaoAcao({
  ...
  acao: "escolher" | "ceder" | "cancelar" | "removerBloqueio";
  id: string;
  rotulo: string;
  ...
  function executar() {
    iniciar(async () => {
      const fn = { escolher: escolherSemana, ceder: cederSemana, cancelar: cancelarReserva, removerBloqueio }[acao];
      setResultado(await fn(id));
      setPedindo(false);
    });
  }
